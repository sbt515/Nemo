    ...
    : data.SpellsKnown;
        ...
        private void ExportPDF_Click(object sender, RoutedEventArgs e)
        {
            ...
            string safeName = string.IsNullOrWhiteSpace(characterName)
                ? "Untitled"
                : string.Join("_", characterName.Split(Path.GetInvalidFileNameChars()));
        ...
        private void SaveCharacterToFixedPath(bool showMessage = false)
        {
            ...
            try
            {
                string savePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "character.json");
        ...
        private void LoadCharacter_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                string loadPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "character.json");
